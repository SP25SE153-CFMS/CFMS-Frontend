...
import { flockNutritions, flocks } from '@/utils/data/table.data';
...
import { CreateNutritionPlanSchema } from '@/utils/schemas/nutrition-plan.schema';

export default function CardFlockNutrition() {
    const flockId = flocks[0].flockId;
                    ...
                    <Dialog open={open} onOpenChange={onOpenChange}>
                        <DialogContent>
                            ...
                            <ScrollArea className="max-h-[600px]">
                                <AutoForm formSchema={CreateNutritionPlanSchema}>
