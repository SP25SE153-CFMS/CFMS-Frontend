...
export const WarehouseSchema = z.object({
    ...
    maxCapacity: z.coerce.number().positive({ message: 'Dung tích tối đa phải là số dương' }),
    currentCapacity: z.coerce.number().nonnegative({ message: 'Dung tích hiện tại không được âm' }),
